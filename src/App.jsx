...
function CompanyBlock() {
  return (
    <section className="card company-card" id="company">
      ...
      <p>
        ИИ в названии появился не случайно. Мы посмотрели на рынок, поняли, что с ИИ всё
...
function CandidateQuestion() {
  return (
    <section className="card question-card" id="question">
      ...
      <p>
        Это не проверка и не собеседование — это попытка честно поговорить с собой.
      </p>
      ...
      <p className="question-caption">Неправильного ответа нет. Здесь важны не согласие с большинством, а честность мышления.</p>
    </section>
  );
}
